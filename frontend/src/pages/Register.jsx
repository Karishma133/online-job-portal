    ...
    <div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2 bg-white dark:bg-surface-950">
      ...
      <div className="flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <p className="text-surface-400 text-sm mt-1 mb-8">Takes less than a minute</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {roles.map((r) => (
                  <button key={r.value} type="button"
                    ...
                    <span className={`text-xl mb-1.5 block ${form.role === r.value ? 'text-primary-600' : 'text-surface-400'}`}>{r.icon}</span>
                    <p className="text-sm font-semibold text-surface-800 dark:text-surface-200">{r.label}</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" className={`input pl-10 ${errors.name ? 'input-error' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" className={`input pl-10 ${errors.password ? 'input-error' : ''}`}
