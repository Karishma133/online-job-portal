      ...
      <div className="card !p-4 absolute -bottom-6 -left-6 w-[250px] shadow-elevated border-surface-100 dark:border-surface-800">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-surface-400 truncate flex items-center gap-1">
              <HiOutlineGlobeAlt className="shrink-0" /> {truncate(user?.companyWebsite, 24) || 'Add company website'}
            </p>
          </div>
        </div>
        <span className="skill-tag !text-[10px] !py-0.5 flex items-center gap-1 w-fit">
          <HiOutlineBuildingOffice2 className="text-[11px]" /> {user?.companyName ? 'Verified recruiter' : 'Complete company info'}
        </span>
      </div>
